                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="password" class="tpl-form-input" name="shop[password]"
                                           placeholder="请输入门店登录密码" required>
                                </div>
                            </div>
                            
                              <div class="am-form-group">
                                <label class="am-u-sm-3  am-u-lg-2 am-form-label form-require"> 绑定用户 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="widget-become-goods am-form-file am-margin-top-xs">
                                        <button type="button"
                                                class="j-selectUser  am-btn am-btn-secondary am-radius">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="shop[address]"
                                         id="address"  placeholder="请输入详细地址" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-block">
                                        <input type="text"  id="coordinate"
                                               ...
                                               placeholder="请选择门店坐标"  required>
                                             <!--    <input type="text"  id="longitude"
                                               class="tpl-form-input" name="shop[longitude]"
                                               placeholder="请选择门店经度"  required>
                                                 <input type="text"  id="latitude"
                                               class="tpl-form-input" name="shop[latitude]"
                                               placeholder="请选择门店经维度"  required> -->
                                    </div>
