...
<script type="text/javascript">
    ...
    qq.maps.event.addListener(map, "click", function (e) {
        ...
        window.parent.document.getElementById("coordinate").value=e.latLng.getLat().toFixed(6) + "," + e.latLng.getLng().toFixed(6);
     //   window.parent.document.getElementById("longitude").value=e.latLng.getLat().toFixed(6) ;
     //   window.parent.document.getElementById("latitude").value=e.latLng.getLng().toFixed(6);
        ...
        $.getJSON(url3, function (result) {
            if (result.result != undefined) {
                ...
                window.parent.document.getElementById("address").value=result.result.address;
            } else {
            ...
            if (result.count) {
                ...
                each(result.data, function (n, ele) {
                    ...
                    var listener3 = qq.maps.event.addDomListener(marker, "click", function () {
                        ...
                        window.parent.document.getElementById("address").value=document.getElementById("addr_cur").value;
                         });
    ...
    function setFlagClicked(arr, index) {
        each(markerArray, function (n, ele) {
         ...
         //       parent.$("#coordinate").val(document.getElementById("poi_cur").value);
                window.parent.document.getElementById("coordinate").value=latLng.getLat().toFixed(6) + "," + latLng.getLng().toFixed(6);
