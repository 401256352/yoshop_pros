                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                             ...
                             <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 直推人数 </label>
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="grade[refereecount]"
                                           value="<?= $model['refereecount'] ?>" placeholder="请输入直推人数 " required>
                                    <small>例如：5、15、20、50</small>
                                </div>
                            </div>
                            
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 每日签到奖励贡献值 </label>
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="grade[daycontribute]"
                                           value="<?= $model['daycontribute'] ?>" placeholder="请输入每日签到奖励贡献值 " required>
                                    <small>例如：5、15、20、50</small>
                                </div>
                            </div>
                            
                             <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 直推1人奖励贡献 </label>
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="grade[contribute]"
                                           value="<?= $model['contribute'] ?>" placeholder="请输入直推1人奖励贡献值 " required>
                                    <small>例如：5、15、20、50</small>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <div class="am-input-group">
                                        ...
                                        <input type="number" class="am-form-field" name="grade[equity][discount]"
                                               value="<?= $model['equity']['discount'] ?>" max="10" min="0"
                                               required>
